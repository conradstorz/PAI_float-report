...
from process_float import process_floatReport_csv
...
def defineLoggers():
    ...
    logger.add(
        ...
        level="INFO",  # above line would simplify output to message only
        ...
        for indx, value in enumerate(files):
            ...
            for ext in extension:
                ...
                if inputfile != "" and inputfile != None:
                    ...
                    if functions[indx](output_file, inputfile, filedate):
                        args = os.sys.argv
